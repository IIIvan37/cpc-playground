  ...
  return (
    ...
    >
      <div className={styles.sectionsGrid}>
        ...
        <div className={styles.column}>
          <div className={styles.section}>
            ...
            {availableDependencies.length > 0 ? (
              ...
              <div className={styles.helpText}>
                No libraries available. Create a project and mark it as a
                library to use it as a dependency.
              </div>
            )}
          </div>
        </div>
        ...
        <div
          className={`${styles.section} ${styles.dangerSection} ${styles.fullWidth}`}
        >
