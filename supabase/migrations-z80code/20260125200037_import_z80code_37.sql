-- Migration: Import z80code projects batch 37
-- Projects 73 to 74
-- Generated: 2026-01-25T21:43:30.193931

-- Project 73: deltadotplasma by tronic
DO $$
DECLARE
...
BEGIN
  ...
  VALUES (
    ...
    'deltadotplasma',
    'Imported from z80Code. Author: tronic. animation 4 fun',
    'public',
    false,
    false,
    '2021-04-20T17:49:12.735000'::timestamptz,
    '2021-06-18T22:29:09.439000'::timestamptz
  );
  ...
  VALUES (
    project_uuid,
    'main.asm',
    '; DeltaDotPlasma - Petit essai d''animation, "pour le plaisir" ^^
; 80x80 - 53 frames - 1 ligne sur 2 (80x40 en vrai ^^) - mode 1
; delta typé "deltabulus" - ld a,val + ld (nn),a en pagaille... (généré par un tool perso)
; L''avantage, c''est que ça prend quasiment rien en TM... (voir bande rouge)
; Par contre... ça bouffe en ram... bank c0 plutôt bien remplie mais pas en entier + c4 + c5.
; Serait intéressant de faire un comparatif/test/ratio/TM/RAM/Décompression (zx0,zx1,zx2 ?)
; Après quoi, autant la duplication en Y est facile (rupture de 10 lignes = 8x10=80...)
; En X c''est plus "chiant" et obligation de re-copier (ldi dans ce cas, bande bleue) ou à la pile? 
;
; Rajout d''une petite musique zx (bande violette) en c6 (Player ayc/mdr/ovl)
; Pas si évident que ça finalement à caser avec ces "contextes de piles & les banks"...
; https://zxart.ee/eng/authors/m/mic/destination/qid:298546/
;
; Il reste du TM pour rajouter autre chose... Quoi ? Aucune idée ^^
;
; PS : pour "travailler" l''animation de départ (trouvée sur giphy hein...)
; j''utilise "Graphics Gale", il y a des options vraiment très intéressantes... 
; Notemment la possibilité d''effectuer des "transformations" (slope dans ce cas)
; à la volée & en temps réel sur les "n" frames d''un gif animé... Entre autre...
; https://graphicsgale.com/us/
; Et, transfert des images avec Martine + GUI
...
start
		...
		ld bc,#7f00:ld a,ink01:out (c),c:out (c),a
		ld bc,#7f01:ld a,ink00:out (c),c:out (c),a
		ld bc,#7f02:ld a,ink05:out (c),c:out (c),a
		ld bc,#7f03:ld a,ink14:out (c),c:out (c),a
...
ld hl,#C000 : ld de,#C000+20 : repeat 20: ldi : rend 
...
ld hl,#C050 : ld de,#C050+20 : repeat 20: ldi : rend 
ld hl,#D050 : ld de,#D050+20 : repeat 20: ldi : rend 
ld hl,#E050 : ld de,#E050+20 : repeat 20: ldi : rend 
ld hl,#F050 : ld de,#F050+20 : repeat 20: ldi : rend 
...
ld hl,#C0F0 : ld de,#C0F0+20 : repeat 20: ldi : rend 
ld hl,#D0F0 : ld de,#D0F0+20 : repeat 20: ldi : rend 
ld hl,#E0F0 : ld de,#E0F0+20 : repeat 20: ldi : rend 
ld hl,#F0F0 : ld de,#F0F0+20 : repeat 20: ldi : rend 
...
ld hl,#C190 : ld de,#C190+20 : repeat 20: ldi : rend 
ld hl,#D190 : ld de,#D190+20 : repeat 20: ldi : rend 
ld hl,#E190 : ld de,#E190+20 : repeat 20: ldi : rend 
ld hl,#F190 : ld de,#F190+20 : repeat 20: ldi : rend 
...
ld hl,#C230 : ld de,#C230+20 : repeat 20: ldi : rend 
ld hl,#D230 : ld de,#D230+20 : repeat 20: ldi : rend 
ld hl,#E230 : ld de,#E230+20 : repeat 20: ldi : rend 
ld hl,#F230 : ld de,#F230+20 : repeat 20: ldi : rend 
...
ld hl,#C2D0 : ld de,#C2D0+20 : repeat 20: ldi : rend 
ld hl,#D2D0 : ld de,#D2D0+20 : repeat 20: ldi : rend 
ld hl,#E2D0 : ld de,#E2D0+20 : repeat 20: ldi : rend 
ld hl,#F2D0 : ld de,#F2D0+20 : repeat 20: ldi : rend 


ld hl,#C000 : ld de,#C000+40 : repeat 40: ldi : rend 
ld hl,#D000 : ld de,#D000+40 : repeat 40: ldi : rend 
ld hl,#E000 : ld de,#E000+40 : repeat 40: ldi : rend 
ld hl,#F000 : ld de,#F000+40 : repeat 40: ldi : rend 
ld hl,#C050 : ld de,#C050+40 : repeat 40: ldi : rend 
ld hl,#D050 : ld de,#D050+40 : repeat 40: ldi : rend 
ld hl,#E050 : ld de,#E050+40 : repeat 40: ldi : rend 
ld hl,#F050 : ld de,#F050+40 : repeat 40: ldi : rend 
ld hl,#C0A0 : ld de,#C0A0+40 : repeat 40: ldi : rend 
ld hl,#D0A0 : ld de,#D0A0+40 : repeat 40: ldi : rend 
ld hl,#E0A0 : ld de,#E0A0+40 : repeat 40: ldi : rend 
ld hl,#F0A0 : ld de,#F0A0+40 : repeat 40: ldi : rend 
ld hl,#C0F0 : ld de,#C0F0+40 : repeat 40: ldi : rend 
ld hl,#D0F0 : ld de,#D0F0+40 : repeat 40: ldi : rend 
ld hl,#E0F0 : ld de,#E0F0+40 : repeat 40: ldi : rend 
ld hl,#F0F0 : ld de,#F0F0+40 : repeat 40: ldi : rend 
ld hl,#C140 : ld de,#C140+40 : repeat 40: ldi : rend 
ld hl,#D140 : ld de,#D140+40 : repeat 40: ldi : rend 
ld hl,#E140 : ld de,#E140+40 : repeat 40: ldi : rend 
ld hl,#F140 : ld de,#F140+40 : repeat 40: ldi : rend 
ld hl,#C190 : ld de,#C190+40 : repeat 40: ldi : rend 
ld hl,#D190 : ld de,#D190+40 : repeat 40: ldi : rend 
ld hl,#E190 : ld de,#E190+40 : repeat 40: ldi : rend 
ld hl,#F190 : ld de,#F190+40 : repeat 40: ldi : rend 
ld hl,#C1E0 : ld de,#C1E0+40 : repeat 40: ldi : rend 
ld hl,#D1E0 : ld de,#D1E0+40 : repeat 40: ldi : rend 
ld hl,#E1E0 : ld de,#E1E0+40 : repeat 40: ldi : rend 
ld hl,#F1E0 : ld de,#F1E0+40 : repeat 40: ldi : rend 
ld hl,#C230 : ld de,#C230+40 : repeat 40: ldi : rend 
ld hl,#D230 : ld de,#D230+40 : repeat 40: ldi : rend 
ld hl,#E230 : ld de,#E230+40 : repeat 40: ldi : rend 
ld hl,#F230 : ld de,#F230+40 : repeat 40: ldi : rend 
ld hl,#C280 : ld de,#C280+40 : repeat 40: ldi : rend 
ld hl,#D280 : ld de,#D280+40 : repeat 40: ldi : rend 
ld hl,#E280 : ld de,#E280+40 : repeat 40: ldi : rend 
ld hl,#F280 : ld de,#F280+40 : repeat 40: ldi : rend 
ld hl,#C2D0 : ld de,#C2D0+40 : repeat 40: ldi : rend 
ld hl,#D2D0 : ld de,#D2D0+40 : repeat 40: ldi : rend 
ld hl,#E2D0 : ld de,#E2D0+40 : repeat 40: ldi : rend 
ld hl,#F2D0 : ld de,#F2D0+40 : repeat 40: ldi : rend 
...
stack	ld sp,0				; on revient dans notre contexte de pile (table de ret)      
		...
		wline 60		; il en reste, on peut rajouter des trucs ^^        
...
',
  ...
  -- Add category tag: animation-4-fun
  SELECT id INTO tag_uuid FROM tags WHERE name = 'animation-4-fun';
  IF tag_uuid IS NOT NULL THEN
    INSERT INTO project_tags (project_id, tag_id) VALUES (project_uuid, tag_uuid);
  END IF;
END $$;

-- Project 74: spirale-2 by gurneyh
DO $$
DECLARE
  project_uuid uuid := gen_random_uuid();
  tag_uuid uuid;
BEGIN
  ...
  VALUES (
    ...
    false,
    false,
    '2021-06-04T20:42:42.571000'::timestamptz,
    '2021-06-18T13:51:44.785000'::timestamptz
  );
...
; - 64 (x3)dots au lieu de 32 (x3)
; - On évite les calcules en précalculant les adresses écran en Y
; - on utilise la pile pour effacer les dots
; - la boucle d''effacement est déroulée
; => à peu près le même temps pour le double de dots
...
repeat 50, yy
y = (yy - 1) * 4
	db hi(#c000 + (y & 7) * #800 + (y >> 3) * 80)
rend

align 256
repeat 50, yy
y = (yy - 1) * 4
	db lo(#c000 + (y & 7) * #800 + (y >> 3) * 80)
rend
