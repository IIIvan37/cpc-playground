-- Migration: Import z80code projects batch 74
-- Projects 147 to 148
-- Generated: 2026-01-25T21:43:30.204681

-- Project 147: aky-player example - stabilized by siko
DO $$
DECLARE
...
BEGIN
  ...
  VALUES (
    ...
    'aky-player example - stabilized',
    'Imported from z80Code. Author: siko. Arkos Tracker AKY Player (stabilized)',
    'public',
    false,
    false,
    '2021-10-16T11:29:51.418000'::timestamptz,
    '2021-10-16T11:36:08.322000'::timestamptz
  );
  ...
  VALUES (
    project_uuid,
    'main.asm',
    '        ;AKY Player (Stabilized Version - 1174 us) Test for AMSTRAD CPC.                
...
-- Project 148: program337 by siko
DO $$
DECLARE
  project_uuid uuid := gen_random_uuid();
  tag_uuid uuid;
BEGIN
  ...
  VALUES (
    ...
    'bd6a166d-e0bf-4374-94c3-5222e517d75c'::uuid,
    'program337',
    'Imported from z80Code. Author: siko. some buggy behaviour',
    'public',
    false,
    false,
    '2023-01-14T00:07:20.992000'::timestamptz,
    '2023-01-14T00:12:26.931000'::timestamptz
  );
